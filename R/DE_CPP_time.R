                            ...
                            nThreads_int, nThreads_l, nThreads_fold, nfolds, nsimulations, search, isTimeDiscrete, flagMass, flagLumped)
{
  ...
  bigsol <- .Call("Density_Estimation_time", data, data_time, FEMbasis$mesh, mesh_time, FEMbasis$order, mydim, ndim, fvec,
                  ...
                  nThreads_int, nThreads_l, nThreads_fold, step_method, direction_method, preprocess_method, search, isTimeDiscrete, flagMass, flagLumped,
                  PACKAGE = "fdaPDE")
...
CPP_FEM.manifold.DE_time <- function(data, data_time, FEMbasis, mesh_time, lambda, lambda_time, fvec, heatStep, heatIter,
                                     ...
                                     tol2, print, nThreads_int, nThreads_l, nThreads_fold, nfolds, nsimulations, search, isTimeDiscrete, flagMass, flagLumped)
{
  # Indexes in C++ starts from 0, in R from 1, opportune transformation
  ...
  bigsol <- .Call("Density_Estimation_time", data, data_time, FEMbasis$mesh, mesh_time, FEMbasis$order, mydim, ndim, fvec,
                  ...
                  print, nThreads_int, nThreads_l, nThreads_fold, step_method, direction_method, preprocess_method, search, isTimeDiscrete, flagMass, flagLumped,
                  PACKAGE = "fdaPDE")
